...
namespace NeuZephyr::Graph {
    ...
    public:
        ...
        /**
         * @brief Adds an input node to the computational graph using a shape initializer list.
         *
         * This method creates a new `InputNode` using the provided shape (as an initializer list) and a flag indicating
         * whether gradients are required. The new node is added to the `ComputeGraph` object and stored in the `inputNodes`
         * and `nodes` lists. The node's name is stored in the `nodeRoster` and `nodeRosterReverse` maps, making it easy to
         * look up by name. If no name is provided, a unique name is generated.
         *
         * @param shape The shape of the input node, provided as an initializer list of integers. This defines the dimensions
         *              of the input tensor.
         * @param requires_grad A boolean indicating whether the input node requires gradients for backpropagation.
         * @param name The name of the input node. If "default", a unique name is generated.
         * @return A pointer to the newly created `InputNode`.
